...
public class SuperStateMachine : MonoBehaviour {
	...
	public class State
	{
		public System.Action DoSuperUpdate = DoNothing;
	...
	void ConfigureCurrentState()
	{
		...
		state.DoSuperUpdate = ConfigureDelegate<System.Action>("SuperUpdate", DoNothing);
		state.enterState = ConfigureDelegate<System.Action>("EnterState", DoNothing);
		state.exitState = ConfigureDelegate<System.Action>("ExitState", DoNothing);
